...
final shortVideoTab2Provider =
    AsyncNotifierProvider.autoDispose<ShortVideoTab2Notifier, List<VideoModel>>(
      ShortVideoTab2Notifier.new,
    );

class ShortVideoTab2Notifier extends AsyncNotifier<List<VideoModel>> {
